...
return [
    ...
    "DRIVER_VEHICLE_INELIGIBLE" => "Driver does not have an eligible vehicle, the company should check associated vehicles rejection reasons to the driver then fix the reason then re-register the driver and vehicle again",
