...
return [
    ...
    "not_valid_vehicle_pallete" => "لوحة هذه السيارة موجوده من قبل" ,
    "not_valid_vehicle_pallete_letter" => "حروف لوحة السيارة غير مطابقة للحروف المحددة للاستخدام",
    "you_cant_more_than_one_pack" => "لا يمكن ان يكون لديك اكثر من باقة واحده" ,
    "time_range_not_valid" => "هذا التوقيت يتقاطع مع رحلة اخري" ,
    ...
    'attributes'           => [
        ...
        'ussid' => 'صورة الهوية',
        'USSID' => 'صورة الهوية',
        'ussid_number' => 'رقم الهوية',
        'USSID_number' => 'رقم الهوية',
        'type' => 'النوع',
        'avatar' => 'الصورة الشخصية',
        'iban' => 'أيبان',
        'bank_personal_id' => 'بيانات الحساب البنكي',
        'amount' => 'المبلغ',
        'reject_reason' => "سبب الرفض",
        'driver_license_number' => 'رقم رخصة القيادة',
        'driver_license_end_date' => 'تاريخ انتهاء رخصة القيادة',
