<x-pages.layout :title="t_('user details')">
    <!-- row -->
                ...
                <div class="card card-invoice">
                    <div class="card-body">
                        <div class="invoice-header">
                            ...
                            <div class="row">
                                <x-component.input :col_size="3" value="{{ $model?->name }}" :label="t_('name')" />
                                <x-component.input :col_size="3" value="{{ $model?->email }}" :label="t_('email')" />
                                <x-component.input :col_size="3" value="{{ $model?->phone }}" :label="t_('phone')" />
                                <x-component.input :col_size="3" value="{{ $model?->username }}" :label="t_('username')" />
                            </div>
