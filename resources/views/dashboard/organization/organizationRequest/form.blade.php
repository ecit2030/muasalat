<x-form route="dashboard.organization.organizationRequest" :title="t_('organization')">
    ...
    <div>
        <div class="btn btn-success"
            onclick="window.location='{{ route('dashboard.organization.organizationRequest.approve', ['id' => $model->id]) }}'">
            {{ t_('approve') }}</div>

        <div class="btn btn-danger"
            onclick="window.location='{{ route('dashboard.organization.organizationRequest.revoke', ['id' => $model->id]) }}'">
            {{ t_('revoke') }}</div>
    </div>
    ...
    <div class="row">
        ...
        <x-form.input col_size="4" name="phone" :value="$phone" type="text" :label="t_('Phone')" />
