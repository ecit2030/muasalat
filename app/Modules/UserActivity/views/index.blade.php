<x-pages.layout ng-app="myApp" ng-controller="LogCtrl" :title="t_('activity log')">

    <x-slot name="prepend">

        <div id="accordion">
            <div class="card border border-primary mb-5 custom_filter">
                <a data-bs-toggle="collapse" data-parent="#accordion" href="#collapseOne" class="btn btn-primary collapsed" aria-expanded="false">
                ...
                <div id="collapseOne" class="panel-collapse in collapse">
                    <div class="card-body">
                        <div class="row justify-content-center">
                            ...
                            <div class="filter_item full_width_param user_list_box col-md-2">
                                <label class="form-label">{{t_('USER')}}</label>
                                ...
                                <div id="user_list" ng-show="userList.length && filter.user_id">
                                    <!---->
                                    <div class="single_user text-danger" ng-repeat="user in userList" ng-click="onUserSelect(user)">
                                        <p>@{{ user.name }} <br>
                                            <span class="cursor-pointer">@{{ user.email }}</span>
                                        </p>
                                    </div>
                                    <!---->
                                </div>
                            ...
                            <div class="filter_item col-md-2">
                                <label class="form-label">{{t_('LOG TYPE')}}</label>

                                <select class="form-select" ng-model="filter.log_type">
                            ...
                            <div class="filter_item col-md-2">
                                <label class="form-label">{{t_('TABLE')}}</label>
                                <select class="form-select" ng-model="filter.table">
                            ...
                            <div class="filter_item col-md-2">
                                <label class="form-label">{{t_('FROM DATE')}}</label>
                                <date-input ng-model="filter.from_date"></date-input>
                            </div>
                            <div class="filter_item col-md-2">
                                <label class="form-label">{{t_('TO DATE')}}</label>
                                <date-input ng-model="filter.to_date"></date-input>
                            </div>
                            <div class="filter_item col-md-2 d-flex justify-content-center">


                                <button class="btn btn-info btn-sm m-2" ng-class="{btn_filter_active : activeFilter == true}"
                                        ng-click="filterData(filter)">{{t_("FILTER")}}
                                </button>
                                <button class="btn btn-warning btn-sm m-2" ng-show="activeFilter" ng-click="resetParam()">{{t_('RESET')}}</button>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <table class="table table-hover table-rounded table-striped border gy-7 gs-7">
                                    ...
                                    <tr ng-repeat="log in data |filter: selectedType track by $index">
                                        ...
                                        <td class="action_column text_right">
                                            <button class="btn btn-primary" ng-click="showPopup(log)">SHOW</button>
                                        </td>
                                    </tr>
                                </table>
                            </div>
    ...
    <x-slot:filters>
        <p class="text_light">{{t_('Showing')}}
            @{{response.from}} {{t_('to')}} @{{response.to}} {{t_('of')}}
            @{{response.total}} {{t_('records')}}</p>
    ...
    <x-slot:actions>
        ...
        <button class="btn btn-danger" ng-click="deleteLog()">Delete data older than {{ config('user-activity.delete_limit') }} days</button>
