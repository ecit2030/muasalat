        ...
        'app' => [
            ...
            'credentials' => [
                'file'           => env('FIREBASE_CREDENTIALS',
                    env('GOOGLE_APPLICATION_CREDENTIALS', app_path("Support{$ds}Files{$ds}GOOGLE_APPLICATION_CREDENTIALS.json"))),
            ...
            /*
             * ------------------------------------------------------------------------
             * HTTP Student Options
             * ------------------------------------------------------------------------
             *
             * Behavior of the HTTP Student performing the API requests
             */
            'http_client_options' => [
                /*
