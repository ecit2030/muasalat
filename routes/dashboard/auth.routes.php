...
Route::get('/test', function () {
    $trip = \App\Models\Trip::find(2245);

    $chechout = new \App\Services\Payment();
    return $chechout->getCheckout($trip, 2, $scheduled_invoice = 0);
});

Route::get('hyperPay/{invoiceId}/{payment_method}/{scheduled_invoice}',
    [\App\Http\Controllers\CheckoutController::class, 'viewForm'])->name('hyperPay');

Route::get('hyperPay/callback',
    [\App\Http\Controllers\CheckoutController::class, 'callback'])->name('hyperPay.callback');
